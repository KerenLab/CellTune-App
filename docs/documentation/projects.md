...
CellTune_Data is where you place the raw inputs that CellTune will use. (see [Data Preparation section](/documentation/getting-started/data-preparation))
...
![Example_Project_Folder](/assets/documentation/Example_Project_Folder.png){: width="55%"}   
...
Before you close the project it will ask if you want to save (you should!).
![Save_Project_Close](/assets/documentation/Save_Project_Close.png){: width="45%"}   
