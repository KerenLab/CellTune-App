...
> Ask your self if a cell was negative for CD45, positive for CD3, and positive for CD4 what would I classify it as? If it is still CD4T then CD45 is not a `PrimaryMarker`. 
