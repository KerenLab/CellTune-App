...
***Seriously*** compact, informative names make classification and review much easier. For example, use CD8T, not “CD8+ T cells”—trust us, this will make your life much happier. When writing and preparing figures for publication, you will change all the names to your preferred presentation style anyway (e.g., adding superscripts).
