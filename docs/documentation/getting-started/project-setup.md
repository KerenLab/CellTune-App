...
Then select your images directory. The images can reside in CellTune_Data/{PROJ_NAME}/Images folder or elsewhere. They should be [formatted and pre-processed](/documentation/data-preparation/images) already. 
...
![NewProject_1_ImageImport](/assets/documentation/NewProject_1_ImageImport.png){: width="100%"}   
...
![NewProject_3_SetChannelsInfo](/assets/documentation/NewProject_3_SetChannelsInfo.png){: width="100%"}   
...
After setting the segmentation, the channels will populate the channel box. You can move channels to the right and exclude them. (You need to exclude them before continuing.)

![NewProject_5_ChannelsList](/assets/documentation/NewProject_5_ChannelsList.png){: width="100%"}   

When you finish with the dialog and click continue, Zarr's will be generated for your images. These are optimized pyramidal-capable images. Please be patient:

![NewProject_6_GenerateZarr](/assets/documentation/NewProject_6_GenerateZarr.png){: width="100%"}   
...
![NewProject_7_CalculateFeatures](/assets/documentation/NewProject_7_CalculateFeatures.png){: width="100%"}  

When it is complete you will see the following message: 
![NewProject_8_DoneFeatures](/assets/documentation/NewProject_8_DoneFeatures.png){: width="100%"}   
